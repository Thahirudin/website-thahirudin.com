...
$idkategori = $_GET['idkategori'];
    ...
    $a = mysqli_query($koneksi, "select * from konten where idkategori = '$idkategori' ORDER BY tanggal DESC");
    $c = mysqli_query($koneksi, "select * from kategori where idkategori = '$idkategori'");  
...
<meta charset="utf-8">
    ...
    <meta name="description" content="Thahirudin.com adalah website yang berisi mengenai konten yang family friendly">
    <meta name="keyword" content="kesehatan, Thahirudin, teknologi, pemrograman">
    <meta name="author" content="Thahirudin">
    <title><?php echo $row3 ["nama"];?></title>
<style type="text/css">
       a{
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col kontenn">
          ...
          <div class="card">
            ...
            <img src="admin/asset/img/<?php echo $row["gambar"];?>" height="180px" class="card-img-top" alt="...">
            <div class="card-body">
